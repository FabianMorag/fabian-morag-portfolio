...
#regular-entry(
  [
    ...
    - Gestioné respaldos de la base de datos periódicamente (PostgreSQL)
...
#strong[Lenguajes de programación:] HTML, CSS, JavaScript, TypeScript, Python, SQL, GraphQL

#strong[Frameworks:] React, Next.js, Astro, Django, Express.js

#strong[Infraestructura y DevOps:] Docker, Nginx, GCP, Podman, Ansible
